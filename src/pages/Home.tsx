...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-amber-50">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-orange-800 to-orange-700 text-white py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            <Link 
              to="/squad"
              className="bg-white text-orange-800 px-8 py-3 rounded-lg font-semibold hover:bg-orange-50 transition"
            >
              View Team Roster
            </Link>
            <Link 
              to="/matches"
              className="bg-blue-900 text-white px-8 py-3 rounded-lg font-semibold hover:bg-green-950 transition border-2 border-white"
            >
              Match Schedule
            </Link>
          </div>
      ...
      <section className="max-w-6xl mx-auto py-16 px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Link to="/squad" className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition border-l-4 border-orange-600">
      ...
      <section className="max-w-6xl mx-auto py-12 px-6">
        <div className="bg-orange-800 text-white p-10 rounded-xl">
          ...
          <div className="grid md:grid-cols-2 gap-6 text-sm">
            <div className="bg-blue-900 p-4 rounded-lg">
              ...
              <p className="text-blue-200">Keep your contact info and bio current</p>
            </div>
            <div className="bg-blue-900 p-4 rounded-lg">
              <h4 className="font-bold mb-2">✓ Track Equipment</h4>
              <p className="text-blue-200">Mark what you have: Practice T-shirt, Match T-shirt, etc.</p>
            </div>
          </div>
          <Link 
            to="/login"
            className="inline-block mt-6 bg-white text-orange-800 px-6 py-3 rounded-lg font-semibold hover:bg-orange-50 transition"
          >
            Player Login
          </Link>
        </div>
